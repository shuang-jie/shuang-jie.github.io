...
<div class="pub-list">
  ...
  <div class="pub">
    <div class="pub-thumb"><img src="./assets/img/papers/phylogeny-selection.png" alt="Selected local subtree: Gordonibacter, Senegalimassilia, Ellagibacter, Adlercreutzia" loading="lazy"></div>
    <div class="pub-body">
