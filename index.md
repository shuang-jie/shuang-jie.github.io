...
Welcome! I am currently a Postdoctoral Fellow in the Department of Statistics and Data Sciences at the [University of Texas at Austin](https://stat.utexas.edu/), supervised by [Dr. Yang Ni](https://nystat.github.io/yni/).
...
My research develops Bayesian statistical methods for complex, high-dimensional data, with an emphasis on probabilistic generative modeling of feature interactions and structure learning in complex systems. I am particularly interested in factor models, graphical models, longitudinal modeling, and density regression. Methods development is strongly motivated by addressing scientific questions in biomedical and biological applications.
